...
function TRANG1({Data1}) {
  ...
  const [RowData, SetRowData] = useState([])
    ...
    const hanldeDeleteClose = () => { SetDeleteShow(false) }
      ...
      const hanldeaddClose = () => { SetaddShow(false) }
...
<Button size='sm' variant='warning'onClick={()=> {handleaddShow()}}>CREATE</Button>
                ...
                >
                    ...
                    <Modal.Body>
                        <div>
                            ...
                            <div className='form-group mt-3'>
                                <label>Level</label>
                                <input type="text" className='form-control' onChange={(e) => setlevel(e.target.value)} placeholder="Please Enter..."  />
                                
                            </div>
                            <div className='form-group mt-3'>
                                <label>Description</label>
                                <input type="text" className='form-control' onChange={(e) => setdescription(e.target.value)} placeholder="Please Enter..."  />
                                
                            </div>
                            <div className='form-group mt-3'>
                                <label>End-Date</label>
                                <input type="date" className='form-control' onChange={(e) => setenddate(e.target.value)} placeholder="Please Enter..." />
                                
                            </div>
                           
                           
                            <Button type='submit' className='btn btn-warning mt-4' onClick={handleSubmite}>CREATE Task</Button>
                        </div>
                    </Modal.Body>
                    <Modal.Footer>
                        <Button variant='secondary' onClick={hanldeaddClose}>Close</Button>
                    </Modal.Footer>
                </Modal>
            </div>
